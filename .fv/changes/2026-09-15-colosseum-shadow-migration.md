...
**The correction set is committed and gated.** Full local and Gula CI pass, fresh read-only closure reviews found no remaining high/medium fail-open or data-loss issue, and the real dossier tree passed a dry run without mutation. No real project has been shadow-applied.
